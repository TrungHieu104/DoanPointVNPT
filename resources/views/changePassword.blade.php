        ...
        <div class="limiter">
            <div class="container-login100" style="background-image: url('images/bg-tnvn.png'); ">
                <div class="wrap-login100" style="position: relative">
                    <form action="{{route('changePassword.submit')}}"  class="login100-form validate-form" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <span class="error-text">@error('password')
                            {{ $message }}
                        @enderror</span>
                        ...
                        <span class="error-text">@error('newpassword')
                            {{ $message }}
                        @enderror</span>
                        ...
                        <span class="error-text">@error('re_newpassword')
                            {{ $message }}
                        @enderror</span>
